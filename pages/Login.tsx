...
import { Mail, Lock, ArrowRight, User, Github, Loader2, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex text-white overflow-hidden relative font-sans">
      ...
      <div className="hidden lg:flex w-1/2 relative flex-col justify-between p-12 z-10 pointer-events-none">
        <div className="flex items-center gap-3 pointer-events-auto">
          ...
          <span className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">Smart Expense</span>
        </div>
        ...
        <div className="relative">
           ...
           >
             ...
             <p className="text-slate-600 dark:text-slate-400 text-lg max-w-md leading-relaxed">
               Track expenses, set budgets, and achieve your saving goals with the power of AI-driven insights.
             </p>
           </motion.div>
           ...
           >
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full bg-emerald-500/20 flex items-center justify-center">
                  <User className="text-emerald-500 dark:text-emerald-400" size={20} />
                </div>
                <div>
              ...
              <div className="h-20 bg-slate-100 dark:bg-slate-700/50 rounded-xl overflow-hidden relative">
                 ...
                 <svg className="absolute bottom-0 w-full" height="40" preserveAspectRatio="none">
                    <path d="M0,40 L10,35 L20,38 L30,30 L40,32 L50,20 L60,25 L70,10 L80,15 L90,5 L100,10 V40 Z" fill="rgba(16, 185, 129, 0.4)" />
                 </svg>
              </div>
           </motion.div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative z-10">
        <div className="w-full max-w-md">
          ...
          >
             ...
             <div className="mb-8">
               <h2 className="text-3xl font-bold mb-2 text-slate-900 dark:text-white">{isLogin ? 'Welcome back' : 'Create account'}</h2>
             ...
             <form onSubmit={handleSubmit} className="space-y-4">
               {!isLogin && (
                 <div>
                   ...
                   <div className="relative group">
                     <User className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-500 dark:group-focus-within:text-indigo-400 transition-colors" size={18} />
                     <input 
                       type="text" 
               ...
               <div>
                 ...
                 <div className="relative group">
                   <Mail className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-500 dark:group-focus-within:text-indigo-400 transition-colors" size={18} />
                   <input 
                     type="email" 
               ...
               <div>
                 ...
                 <div className="relative group">
                   <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-500 dark:group-focus-within:text-indigo-400 transition-colors" size={18} />
                   <input 
                     type="password" 
                     placeholder="••••••••"
                     className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl py-3 pl-10 pr-4 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-600 focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 outline-none transition-all"
               ...
               {isLogin && (
                 <div className="flex justify-end">
                   <a href="#" className="text-sm text-indigo-500 hover:text-indigo-600 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">Forgot password?</a>
                 </div>
               )}
             ...
             <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white dark:bg-[#161f32] text-slate-500 rounded-full">Or continue with</span>
                </div>
             </div>
             ...
             <div className="grid grid-cols-2 gap-4">
               <button className="flex items-center justify-center gap-2 py-2.5 bg-slate-50 dark:bg-slate-700/50 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl transition-colors">
                  ...
                  <span className="font-medium text-sm text-slate-700 dark:text-white">Google</span>
               </button>
               <button className="flex items-center justify-center gap-2 py-2.5 bg-slate-50 dark:bg-slate-700/50 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl transition-colors">
                  <Github className="w-5 h-5 text-slate-900 dark:text-white" />
                  <span className="font-medium text-sm text-slate-700 dark:text-white">GitHub</span>
               </button>
             </div>
